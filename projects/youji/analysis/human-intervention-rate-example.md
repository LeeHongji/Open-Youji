...
## Example finding from the original youji system
...
## How to reproduce this analysis in your fork

1. define what counts as an intervention
...
This file is adapted from the original youji repo's meta-project analyses and is included as an example of how to quantify increasing autonomy.
