...
Three recurring failure modes from the Youji/OpenAkari lineage are useful to preserve:
...
This file is adapted from the OpenAkari meta-project's self-observation diagnosis. It is included as an example of how the meta-project turns operational failures into research artifacts. As Youji accumulates operational history, local examples should replace or supplement these adapted patterns.
