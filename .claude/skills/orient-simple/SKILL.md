...
5. Convention changes (modifies CLAUDE.md, decisions/, or infra/)
...
4. Create documentation or analysis tasks from standing inventory (see CLAUDE.md "Fleet supply maintenance")
