...
- Tests for trivial logic (i.e., tests that duplicate what the type system already guarantees — NOT tests for simple runtime behavior, which the `/develop` skill requires)
...
- **Downgrade**: Replace with a simpler alternative
