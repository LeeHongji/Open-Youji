...
Synthesis sessions trust all prior artifacts as verified ground truth. Errors in upstream artifacts propagate undetected through the synthesis chain. Seven documented high-severity incidents (flash-240, dimension mismatch, fabricated literature, etc.) show that incorrect data looks plausible and persists until manual audit. See `projects/youji/feedback/feedback-incorrect-experiment-contamination-analysis-2026-03-01.md`.
...
- `/publish` skill: mandatory before Step 1 (content audit)
- `/synthesize` skill: recommended before cross-session synthesis begins
- `/report` skill: recommended before generating reports that cite prior work
