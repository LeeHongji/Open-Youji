...
This procedure eliminates confabulation-based citation fabrication. LLMs can generate plausible-looking citations with real arxiv URL patterns from parametric memory, but the papers may not exist. Mechanical verification prevents this class of hallucination. See [decisions/0019-mandatory-url-verification.md](../../decisions/0019-mandatory-url-verification.md) for incident context.
